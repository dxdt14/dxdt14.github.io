...
excerpt: 'Presented at ICML 2026. Paper presents a unified framework for analyzing model efficiency improvement methods such as token pruning and layer skipping. We then use this framework and do a case-study on layer-skipping, theoretically grounding its results. '
date: 2026-06-24
paperurl: 'https://www.arxiv.org/abs/2509.25584'
citation: 'Hartman, M.*, Jayaraman V.A.*, Choraria, M., Bhimaraju, A., & Varshney, L.R. (2026). Skip-It? Theoretical Conditions for Layer Skipping in Vision-Language Models. Preprint https://www.arxiv.org/abs/2509.25584'
---
